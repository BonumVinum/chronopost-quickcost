...
/**
 * This class stands for calculateDeliveryTime StructType
 * Meta information extracted from the WSDL
 * - type: tns:calculateDeliveryTime
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class CalculateDeliveryTime extends AbstractStructBase
{
    /**
     * The depCountryCode
     * Meta information extracted from the WSDL
     ...
     * @uses CalculateDeliveryTime::setDepCountryCode()
     * @uses CalculateDeliveryTime::setDepZipCode()
     * @uses CalculateDeliveryTime::setArrCountryCode()
     * @uses CalculateDeliveryTime::setArrZipCode()
     * @uses CalculateDeliveryTime::setArrCity()
     * @uses CalculateDeliveryTime::setProductCode()
     * @uses CalculateDeliveryTime::setType()
     * @uses CalculateDeliveryTime::setService()
     * @uses CalculateDeliveryTime::setShippingDate()
     ...
     * @param string $depCountryCode
     * @return \StructType\CalculateDeliveryTime
     */
